...
class Questions:
    ...
    def __init__(self):
        self.politics = {
            1: {'question': 'What are two rights of everyone living in the United States?',
                'answers': 'A. Freedom to petition the government and freedom to disobey traffic laws., B. Freedom of worship and freedom to make treaties with other countries., c. Freedom of speech and freedom to run for president., D. Freedom of speech and freedom of worship.',
                'rAnswer': 'c', 'points': 100},
